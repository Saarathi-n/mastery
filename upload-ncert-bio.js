...
const rawLibRoot = process.env.LIBRARY_ROOT || 'C:\\Users\\Saarathi N\\Downloads\\ncert ooks';
const localRoot = String(rawLibRoot)
  .replace(/\r?\n/g, '\\n')
  .trim()
  .replace(/^['"]|['"]$/g, '');
const localPath = path.join(localRoot, '11 biology');
const cloudinaryFolder = 'mastery/ncert/11 biology';
